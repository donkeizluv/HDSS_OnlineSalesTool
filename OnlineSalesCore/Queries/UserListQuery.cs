...
namespace OnlineSalesCore.Queries
{
    public class UserListQuery : ListQuery<AppUser, AppUserDTO>
    {
        ...
        protected override IQueryable<AppUser> Filter(IQueryable<AppUser> q, Params param)
        {
        ...
        protected override IOrderedQueryable<AppUser> ApplyOrder(IQueryable<AppUser> q, Params param)
        {
            if (q == null || param == null) throw new ArgumentNullException();
