...
namespace OnlineSalesCore.Queries
{
    public class PosListQuery : ListQuery<Pos, PosDTO>
    {
        ...
        protected override IQueryable<Pos> Filter(IQueryable<Pos> q, Params param)
        {
        ...
        protected override IOrderedQueryable<Pos> ApplyOrder(IQueryable<Pos> q, Params param)
        {
            if (q == null || param == null) throw new ArgumentNullException();
