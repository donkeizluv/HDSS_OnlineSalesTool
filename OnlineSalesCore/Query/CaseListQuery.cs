...
namespace OnlineSalesCore.Query
{
    public class CaseListQuery : ListQuery<OnlineOrder, CaseDTO>
    {
        ...
        protected override IQueryable<OnlineOrder> Filter(IQueryable<OnlineOrder> q, ListingParams param)
        {
            ...
            switch (param.Filter)
            {
                ...
                case nameof(OnlineOrder.Product):
                    return q.Where(c => c.Product.Contains(param.Contain));
        ...
        protected override IOrderedQueryable<OnlineOrder> ApplyOrder(IQueryable<OnlineOrder> q, ListingParams param)
        {
            if (q == null || param == null) throw new ArgumentNullException();
        ...
        /// <summary>
        /// All orders assigned to CA under management of this user
        /// </summary>
        /// <returns></returns>
        private IQueryable<OnlineOrder> BDS_Query()
        {
            return Service.DbContext.AppUser
                 .Where(u => u.Manager.UserId == Service.UserId)
                 .SelectMany(u => u.OnlineOrder);
        }
        /// <summary>
        /// Returns all POS
        /// </summary>
